...
//let endpoint='https://api.themoviedb.org/3/tv/top_rated'
//let api_key='?api_key=c71f5b75c8e3c6372967558c16ff597f'
let urlApi=`https://api.themoviedb.org/3/tv/${id}?api_key=c71f5b75c8e3c6372967558c16ff597f`
...
//fetch(`${endpoint}${api_key}&query=${id}`)
fetch(urlApi)
...
fetch(`https://api.themoviedb.org/3/tv/${id}?api_key=c71f5b75c8e3c6372967558c16ff597f`)
.then(function(response){
    return response.json()
})
.then(function(data){
...
fetch(`https://api.themoviedb.org/3/tv/top_rated/${id}?api_key=c71f5b75c8e3c6372967558c16ff597f`)
.then(function(response){
    return response.json()
})
.then(function(data){
